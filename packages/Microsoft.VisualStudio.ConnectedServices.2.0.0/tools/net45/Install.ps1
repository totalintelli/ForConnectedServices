...
# set CopyLocal to false for the Microsoft.VisualStudio.ConnectedServices reference since this assembly
# does not need to be packaged in an extension's .vsix
foreach ($reference in $project.Object.References)
{
	if ($reference.Name -eq "Microsoft.VisualStudio.ConnectedServices")
	{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUWXsHbiCKY6DzPFqKODIGtrGI
# LmSgghWCMIIEwzCCA6ugAwIBAgITMwAAAHD0GL8jIfxQnQAAAAAAcDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFLL
# YTv1u1KKwMHY9vSkI0zj3jEvMEIGCisGAQQBgjcCAQwxNDAyoBiAFgBJAG4AcwB0
# AGEAbABsAC4AcABzADGhFoAUaHR0cDovL21pY3Jvc29mdC5jb20wDQYJKoZIhvcN
# AQEBBQAEggEAIEJd0tvuQaYqvqyjsfUdmOw6/Fzjzn877qJThvXxveMPKrdwvuCI
# hiqVpL0NkriChaIyispvYboucWZu+ehR7oJN504eyAQIswpGJvdTSC1I4MAAVDPT
# Rwz2KJINn7aGmoJVjt4Y3DJZPf+bML+phbD3qVc4x5G4QMCmMfPQuHuw4ghRHTH8
# fagvwUwmEuFSwBmjY1eG1jy7Mwi6pQ06AW4PK55eY7y4W5l0weVoNBoQQAfJcdVb
# 5ZugGYM94eGsNOAXUQLIz/tPqlT82BHTaYKlnBziViGFt0mDDrtKnKhwmaM/BcZK
# Zkuwj4JuenxHqcd6zR0djbvcFgUrWTg/EaGCAigwggIkBgkqhkiG9w0BCQYxggIV
# MIICEQIBATCBjjB3MQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQ
# MA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9u
# MSEwHwYDVQQDExhNaWNyb3NvZnQgVGltZS1TdGFtcCBQQ0ECEzMAAABw9Bi/IyH8
# UJ0AAAAAAHAwCQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEw
# HAYJKoZIhvcNAQkFMQ8XDTE1MDYyNDIwMDAxMFowIwYJKoZIhvcNAQkEMRYEFNwh
# DNhKnrY++dY0MGepIbGTJqAoMA0GCSqGSIb3DQEBBQUABIIBAA+gSZ/8uDMgly8V
# jxkp+hkDIXR68tBw1dYgG6Vm9mJKlH6uBPA74KXTrASxCvEr6Hh/S2+mJd504Yag
# 9Dri2DsmxjQmQhcYncfsFiTXLo9aTG+FTa88Ghmwb2YVcB4k6F7Cc2DFTcSvfdmq
# lzIv1UpN+LYMRdWYHL4q7oMDTAPbhI2XOzLDVRtmRofKHCJ7zrBJqnZVPZBm6kNZ
# rus3v9CM1StLTSuMpLsuTN0qcdwE/ciKs0OY5k9aw7Ks9KLPjcMeLpofPAl5gxEs
# bclnBgFTF5zefnxV5IxSeIpIuor+fxhaa8qlf3+dEHOmioX1eIU++m1tVe8KNj9C
# 5YZAk5s=
